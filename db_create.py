...
# db.session.add(Transaction("Coquitlam","2017-10-22", "Edward Feng", "Edward Feng", "Initial", 0, 0, "Edward Feng", '2017-10-30 14:41:35 PDT'))
# db.session.add(Transaction("Delta","2017-10-22", "Edward Feng", "Edward Feng","Initial", 0, 0, "Edward Feng", '2017-10-30 14:41:35 PDT'))
# db.session.add(Transaction("Surrey","2017-10-22", "Edward Feng", "Edward Feng","Initial", 0, 0, "Edward Feng", '2017-10-30 14:41:35 PDT'))
# db.session.add(Transaction("Vancouver","2017-10-22", "Edward Feng", "Edward Feng", "Initial", 0, 0, "Edward Feng", '2017-10-30 14:41:35 PDT'))
# db.session.add(Transaction("Administration", "2017-10-22", "Edward Feng", "Edward Feng", "Initial", 0, 0, "Edward Feng", '2017-10-30 14:41:35 PDT'))
